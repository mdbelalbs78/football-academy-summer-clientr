...
const ManageClasses = () => {
    ...
    const handleApproved = (data) => {
      console.log(data);
      fetch(
        `http://localhost:5000/classes/approved/${data._id}`,
        {
          method: "PATCH",
        }
      )
    ...
    const handleDeny = (data) => {
      fetch(
        `http://localhost:5000/classes/deny/${data._id}`,
        {
          method: "PATCH",
        }
      )
            ...
            datas.map((data, index) => (
              <tr key={data._id}>
                ...
                <td>
                    ...
                    <button className="btn btn-ghost bg-orange-600" onClick={() => handleApproved(data)} disabled = {data?.status}>approved</button>
                  </td>
                  <td>
                    ...
                    <button className="btn btn-ghost bg-orange-600" onClick={() => handleDeny(data)} disabled = {data?.status}>deny</button>
                  </td>
                  <td>
                    <button
                      className="btn btn-ghost bg-orange-600  text-white"
